...
function my_mce_before_init_insert_formats( $init_array ) {
    $style_formats = array(
        array(
            'title' => 'Big title 1',
            'inline' => 'span',
            'classes' => 'custom_big_title_1'
        ),
        array(
            'title' => 'Big title 2',
            'inline' => 'span',
            'classes' => 'custom_big_title_2'
        ),
        array(
            'title' => 'Big title 3',
            'inline' => 'span',
            'classes' => 'custom_big_title_3'
        ),
        array(
            'title' => 'Big title 4',
            'inline' => 'span',
            'classes' => 'custom_big_title_4'
        ),
        array(
            'title' => 'Big title 5',
            'inline' => 'span',
            'classes' => 'custom_big_title_5'
        ),
        array(
            'title' => 'Big title 6',
            'inline' => 'span',
            'classes' => 'custom_big_title_6'
        ),
        array(
            'title' => 'Big title 7',
            'inline' => 'span',
            'classes' => 'custom_big_title_7'
        ),
        array(
            'title' => 'Big title 8',
            'inline' => 'span',
            'classes' => 'custom_big_title_8'
        ),
//        array(
