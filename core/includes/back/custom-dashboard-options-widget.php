...
function tweaks_widget_html(){
    ...
    $tweaks = array (
        ...
        array (
            'type'          => 'checkbox',
            'label'         => 'disable_gutenberg_everywhere',
            'description'   => __("Disable Gutenberg editor everywhere", TEXTDOMAIN)
        ),
        array (
            'type'          => 'checkbox',
            'label'         => 'disable_gutenberg_for_blog',
            'description'   => __("Disable Gutenberg editor for Blog", TEXTDOMAIN)
        ),
        array (
            'type'          => 'tab_end',
        )
